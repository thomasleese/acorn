...
namespace acorn::codegen {
    ...
    public:
        ...
        void visit_int(ast::Int *node);
        void visit_float(ast::Float *node);
        void visit_complex(ast::Complex *node);
        void visit_string(ast::String *node);
        void visit_list(ast::List *node);
        void visit_dictionary(ast::Dictionary *node);
        void visit_tuple(ast::Tuple *node);
        void visit_call(ast::Call *node);
        void visit_ccall(ast::CCall *node);
        void visit_cast(ast::Cast *node);
        void visit_assignment(ast::Assignment *node);
        void visit_selector(ast::Selector *node);
        void visit_while(ast::While *node);
        void visit_if(ast::If *node);
        void visit_return(ast::Return *node);
        void visit_spawn(ast::Spawn *node);
        void visit_switch(ast::Switch *node);
        void visit_parameter(ast::Parameter *node);
        void visit_let(ast::Let *node);
        void visit_def(ast::Def *node);
        void visit_type(ast::Type *node);
        void visit_module(ast::Module *node);
        void visit_import(ast::Import *node);
        void visit_source_file(ast::SourceFile *node);
